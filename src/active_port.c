...
ACT_CASSERT(sizeof(Event) == 12, "Event type is not the right size.");
ACT_CASSERT(alignof(Event *) == 4, "Alignment of Event pointer type must be a power of 2");
...
ACT_CASSERT(sizeof(Signal) == 16, "Signal type is not the right size.");
ACT_CASSERT(alignof(Signal) == 4, "Alignment Signal type");
